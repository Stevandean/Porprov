    ...
    addDewan: async (req,res) => {
        try{
            ...
            if(cekSkor){
                console.log("data exist");
                let id = cekSkor.id
                if(jadwal.id_peserta_merah === req.body.id_peserta){
                    console.log("merah");
                    let skor = {
                        id_nilai_merah: id
                    }
                ...
                else if(jadwal.id_peserta_biru === req.body.id_peserta){
                    console.log("biru");
                    let skor = {
                        id_nilai_biru: id
                    }
                ...
                let id = dataSkor.id
                if(jadwal.id_pesert_merah === req.body.id_peserta){
                    console.log("merah");
                    let skor = {
                        id_nilai_merah: id
                    }
    ...
    toDewan: async (req,res) => {
        try {
            ...
            for (let i = 0; i < getJuri.length; i++) {
                ...
                let cekNilai = await Tunggal.findOne(
                    {
                        where:{
                        id_juri: idJuri, 
                        id_jadwal: req.body.id_jadwal,
