...
const tgrRegu = () => {
  ...
  return (
    ...
    <globalState.Provider value = {{ showModalInput, setShowModalInput, action, setAction, id, setId, dataRegu, setDataRegu, gelanggang, setGelanggang, pool, setPool, noUndian, setNoUndian, kelas, setKelas, nama1, setNama1, nama2, setNama2, nama3, setNama3, kontingen, setKontingen }}>
      <ModalTgr />
    </globalState.Provider>

    {/* <ImportContext.Provider value = {{ showModalImport, setShowModalImport }}>
      <ModalImport />
