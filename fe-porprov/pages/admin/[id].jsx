...
const detailNilaiTanding = () => {
    ...
    const getJadwal = () => {
        axios.get (BASE_URL + `/api/tanding/` + id)
        .then (res => {
                                        ...
                                        <tr>
                                            ...
                                            <td className='text-lg font-semibold' colSpan={4}>
                                                ...
                                                <div className="grid grid-cols-6 gap-x-2">
                                                    ...
                                                    <div className="border-2 border-[#222954] rounded-lg px-4 py-1 col-span-2 text-center bg-[#FDFFA0]">Poin Masuk</div>
                                                    {/* nilai */}
                                                    <div className="border-2 border-[#222954] rounded-lg px-4 py-1 col-span-3 bg-[#FDFFA0]">{item.poin_merah.poin_masuk}</div>
                                                    {/* total nilai */}
                                        ...
                                        <tr>
                                            ...
                                            <td className='text-lg font-semibold' colSpan={4}>
                                                ...
                                                <div className="grid grid-cols-6 gap-x-2">
                                                    ...
                                                    {/* total nilai */}
                                                    <div className="border-2 border-[#222954] rounded-lg text-center py-1 col-span-1 bg-[#BDEBFF]">{item.poin_merah.jatuhan}</div>
                                                </div>
                                            </td>
                                        </tr>
