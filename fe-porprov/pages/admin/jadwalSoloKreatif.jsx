...
const jadwalSoloKreatif = () => {
    ...
    return (
        ...
        <globalState.Provider value={{ showModalJadwal, setShowModalJadwal, action, setAction, dataJadwalSoloKreatif, setDataJadwalSoloKreatif, partai, setPartai, idBiru, setIdBiru, idMerah, setIdMerah, idJadwal, setIdJadwal, jk, setJk, babak, setBabak}}>
            <ModalJadwal />
