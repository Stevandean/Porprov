...
const tgrGanda = () => {
  ...
  return (
    ...
    <globalState.Provider value = {{ showModalInput, setShowModalInput, action, setAction, id, setId, dataGanda, setDataGanda, gelanggang, setGelanggang, pool, setPool, noUndian, setNoUndian, kelas, setKelas, nama1, setNama1, nama2, setNama2, kontingen, setKontingen }}>
      <ModalTgr />
