                    ...
                    <div className="w-9/12 mx-auto py-10 space-y-8">
                        ...
                        <div className="space-y-5 rounded-lg">
                            ...
                            <div className="grid grid-cols-2 w-full gap-x-7">
                                ...
                                <Link href={'/tanding/layar/detailSelesai'} className={active == 'selesai' ? "bg-[#39ac39] hover:bg-[#2f912f] text-center py-2 rounded-lg" : "bg-[#7ed47e] hover:bg-[#39ac39] text-center py-2 rounded-lg"}>
