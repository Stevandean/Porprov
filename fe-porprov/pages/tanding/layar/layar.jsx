                        ...
                        <div className="w-9/12 mx-auto py-10">
                            ...
                            <div className="grid grid-cols-3 gap-x-3 mb-8">
                                ...
                                <div className="text-[#222954] border-4 border-[#222954] rounded-lg flex justify-center items-center py-3">
                                    <h1 className='text-5xl font-bold'>00:00</h1>
                                </div>
                            ...
                            <div className="grid grid-cols-7 gap-x-5 border-2 border-[#222954] p-4 rounded-lg mb-5">
                                ...
                                <div className="col-span-3 grid grid-cols-2 gap-x-3">
                                    ...
                                    <div className="grid grid-rows-3 gap-y-3">
                                        ...
                                        <div className="flex flex-rows justify-around gap-x-3">
                                            <div className="bg-yellow-300 hover:bg-yellow-400 border-2 border-[#222954] rounded-lg flex justify-center items-center w-full">
                                                <img className='w-14 rotate-90' src="/svg/oneFinger.svg" alt="" />
                                            </div>
                                            <div className="bg-yellow-300 hover:bg-yellow-400 border-2 border-[#222954] rounded-lg flex justify-center items-center w-full">
                                                <img className='w-14' src="/svg/twoFinger.svg" alt="" />
                                            </div>
                                        </div>
                                        {/* teguran */}
                                        <div className="flex flex-rows justify-around gap-x-3">
                                            <div className="bg-yellow-300 hover:bg-yellow-400 border-2 border-[#222954] rounded-lg flex justify-center items-center w-full">
                                                <img className='w-12' src="/svg/oneFinger.svg" alt="" />
                                            </div>
                                            <div className="bg-yellow-300 hover:bg-yellow-400 border-2 border-[#222954] rounded-lg flex justify-center items-center w-full">
                                                <img className='w-14 -rotate-90' src="/svg/twoFinger.svg" alt="" />
                                            </div>
                                        </div>
                                        {/* peringatan */}
                                        <div className="flex flex-rows justify-around gap-x-3">
                                    ...
                                    {/* wrapper score biru */}
                                    <div className="bg-gradient-to-b from-[#0029FF] to-[#001479] rounded-lg flex justify-center items-center">
                                        <h1 className='text-8xl font-bold'>13</h1>
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-col justify-center items-center">
                                    ...
                                    <div className="w-full space-y-1">
                                        <div className="bg-green-600 rounded-lg text-center py-2 w-full">
                                ...
                                <div className="col-span-3 grid grid-cols-2 gap-x-3">
                                    {/* wrapper score biru */}
                                    <div className="bg-gradient-to-b from-[#FF0000] to-[#7a0000] rounded-lg flex justify-center items-center">
                                        <h1 className='text-8xl font-bold'>13</h1>
                                    </div>
                                    {/* wrapper hukuman and total score */}
                                    <div className="grid grid-rows-3 gap-y-3">
                            ...
                            <div className="grid grid-cols-7 gap-x-3 mb-3">
                                {/* wrapper juri indicator biru */}
                                <div className="col-span-3 grid grid-cols-3 gap-x-3">
                                    <div className="bg-yellow-300 rounded-lg text-[#222954] flex justify-center items-center border-2 border-[#222954]">
                                ...
                                <div className="border-2 border-[#222954] rounded-lg">
                                    <div className="flex justify-center items-center py-2 gap-x-3">
                                        <svg width="34px" height="34px" viewBox="0 0 64.00 64.00" fill="#000000" transform="matrix(-1, 0, 0, 1, 0, 0)rotate(-45)" stroke="#000000" stroke-width="2.944">
                                            <path 
