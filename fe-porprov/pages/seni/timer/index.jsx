        ...
        <div className="w-full overflow-y-auto h-screen"> 
          ...
          <div className="bg-white text-white min-h-full">
            ...
            <div className="w-11/12 mx-auto py-10 space-y-6">
              ...
              <div className="grid sm:grid-grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-5 gap-y-5">
                  ...
                  <div className="bg-white border-x-4 border-b-4 border-[#222954] min-h-[29rem] rounded-lg space-y-6">
                    ...
                    <div className="flex flex-col px-5">
                      {dataTunggal.filter(a => a.jk == 'PUTRA').map ((item, index) => (
                        <Link key={index + 1} href={'/seni/timer/putra/tunggal/' + item.kelas} className="bg-[#222954] rounded-lg p-3 mb-4">
                  ...
                  <div className="bg-white border-x-4 border-b-4 border-[#222954] min-h-[29rem] rounded-lg space-y-6">
                    ...
                    <div className="flex flex-col px-5">
                      {dataGanda.filter(a => a.jk == 'PUTRA').map ((item, index) => (
                        <Link key={index + 1} href={'/seni/timer/putra/ganda/' + item.kelas} className="bg-[#222954] rounded-lg p-3 mb-4">
                          <span className='uppercase text-xl font-semibold'>{item.kelas}</span>
                        </Link>
                      ))}
                    </div>
                  ...
                  <div className="bg-white border-x-4 border-b-4 border-[#222954] min-h-[29rem] rounded-lg space-y-6">
                    ...
                    <div className="flex flex-col px-5">
                      {dataRegu.filter(a => a.jk == 'PUTRA').map ((item, index) => (
                        <Link key={index + 1} href={'/seni/timer/putra/regu/' + item.kelas} className="bg-[#222954] rounded-lg p-3 mb-4">
                          <span className='uppercase text-xl font-semibold'>{item.kelas}</span>
                        </Link>
                      ))}
