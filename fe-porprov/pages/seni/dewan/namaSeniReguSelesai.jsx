          ...
          <div className="w-4/5 mx-auto py-10 space-y-5">
            ...
            <div className="flex">
                ...
                <div className="flex flex-col text-center m-auto space-y-3">
                    <span className='text-4xl text-[#2C2F48] font-bold'>Regu</span>
            ...
            <div className="border-2 border-[#222954] p-5 space-y-7 rounded-lg">
                ...
                <div className="grid grid-cols-2 gap-x-7">
                    <Link href= 'namaSeniRegu' className={splitLoc[1] === "namaSeniRegu" ? "bg-[#2C2F48] rounded-lg text-center py-1" : "bg-[#A8A9B3] rounded-lg text-center py-1"}>
                        <span className='text-2xl font-semibold uppercase'>proses</span>
                    </Link>
                    <Link href= 'namaSeniReguSelesai' className={splitLoc[1] === "namaSeniReguSelesai" ? "bg-[#2C2F48] rounded-lg text-center py-1": "bg-[#A8A9B3] rounded-lg text-center py-1"}>
                        ...
                        <tr className='even:bg-[#4C4F6D] odd:bg-[#2C2F48]'>
                            ...
                            <td>
                                <div className="flex flex-row justify-center space-x-2">
                                    <Link href={"monitorSeniRegu"} className="bg-[#253EA3] px-6 py-1 rounded-lg">
                                        <span>Monitor</span>
                                    </Link>
                                    <Link href={"dewanSeniRegu"} className="bg-[#253EA3] px-6 py-1 rounded-lg">
                                        <span>Dewan</span>
                                    </Link>
                                </div>
                            </td>
...
export default namaSeniReguSelesai