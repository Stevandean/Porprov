                ...
                <div className="border-2 border-[#222954] p-5 space-y-4 rounded-lg">
                    ...
                    <table className='w-full table-fixed border-separate border-spacing-x-2'>
                        ...
                        <tbody className='text-center text-[#2C2F48] font-medium'>
                            {/* Technique */}
                            <tr>
                                <td colSpan={2} className="text-lg font-semibold border-2">Technique</td>
                            ...
                            {/* Firmness */}
                            <tr>
                                <td colSpan={2} className="text-lg font-semibold border-2">Firmness</td>
                                <td className='border-2'>9,90</td>
                                <td className='border-2'>9,90</td>
                                <td className='border-2'>9,90</td>
                                <td className='border-2'>9,90</td>
                            ...
                            {/* Soulfulness */}
                            <tr>
                                <td colSpan={2} className="text-lg font-semibold border-2">Soulfulness</td>
                                <td className='border-2'>9,90</td>
                                <td className='border-2'>9,90</td>
                                <td className='border-2'>9,90</td>
                                <td className='border-2'>9,90</td>
                            ...
                            <tr className='bg-[#2C2F48] text-white'>
                                <td colSpan={2} className="text-lg font-semibold border-2">Skor</td>
                                <td className='border-2'>9,90</td>
                                <td className='border-2'>9,90</td>
                                <td className='border-2'>9,90</td>
                                <td className='border-2'>9,90</td>
                        ...
                        <div className="col-span-10">
                            <table className='w-full table-fixed'>
                                ...
                                <tbody className='text-[#FF3030] font-semibold'>
                                    ...
                                    <tr>
                                        <td colSpan={9} className='border-2 border-[#FF3030] px-4'>Pakaian tidak sesuai aturan (Atasan - bawahan, samping - tanjak tidak 1 watna)</td>
                                        <td className='border-2 border-[#FF3030] text-center'>0</td>
                                    </tr>
                                    <tr>
...
export default monitorSeniGanda